...
function ProductivityDashboard({ report, onOpen }) {
  ...
  const rows = [
    { label: "Cumplimiento PMP", value: current.pmpCompliance, previous: previous.pmpCompliance, suffix: "%", detail: `${current.producedUnits} producidas / ${current.plannedUnits} planificadas`, formula: "Unidades producidas ÷ unidades planificadas × 100", tone: "orange", tooltip: "Para obtener este dato:\n1. Ve a Producción > Gestión de órdenes.\n2. Asegúrate de registrar la 'Fecha de entrega pactada' de tus órdenes y avanzarlas a estado 'Terminado'." },
    { label: "Nivel de avance", value: current.progressRate, previous: previous.progressRate, suffix: "%", detail: `${current.executedActivities} ejecutadas / ${current.programmedActivities} programadas`, formula: "Actividades ejecutadas ÷ actividades programadas × 100", tone: "blue", tooltip: "Para obtener este dato:\n1. Ve a Producción > Avance de actividades.\n2. Marca como 'Terminado' o registra progreso en las actividades de tus órdenes." },
    ...
    { label: "Cobertura de seguridad", value: current.safetyCoverage, previous: previous.safetyCoverage, suffix: "%", detail: `${current.safetyCovered} de ${current.safetyTotal} materiales sobre el mínimo`, formula: "Disponible ≥ stock de seguridad calculado", tone: "green", tooltip: "Para obtener este dato:\n1. Ve a Inventario > Insumos y partes.\n2. Configura el 'Stock de seguridad' y registra ingresos de stock para mantener los materiales sobre ese nivel." },
